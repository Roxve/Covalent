...
proc parse_primary_expr(this: var Parser): Node =
  case this.at().tok:
    of TType.num:
...
proc parse_multipictive_expr(this: var Parser): Node =
...
proc parse_additive_expr(this: var Parser): Node =
...
proc parse_expr*(this: var Parser): Node = 
